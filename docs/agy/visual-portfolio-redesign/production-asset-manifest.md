...
### C. Individual Client Brand Logo Records (12 Brands)
...
| :--- | :--- | :---: | :---: | :---: | :---: | :--- | :--- | :--- | :--- |
| **Black Gold Fertilizer** | `private-assets/black-gold-fertilizer/logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/black-gold-fertilizer/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Wajib Livestock** | `private-assets/wajib-livestock/logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/wajib-livestock/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires public name & logo approval |
| **RK Reno Solutions** | `private-assets/rk-reno-solutions/logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/rk-reno-solutions/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Viral Naturals** | `private-assets/client-logos/viral-naturals-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/viral-naturals/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Shopinq Online** | `private-assets/client-logos/shopinq-online-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/shopinq-online/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Super Safety Covers** | `private-assets/client-logos/super-safety-covers-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/super-safety-covers/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Riyadh Finish Pro** | `private-assets/client-logos/riyadh-finish-pro-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/riyadh-finish-pro/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Convort AI** | `private-assets/client-logos/convort-ai-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/convort-ai/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Clearzone Immigration** | `private-assets/client-logos/clearzone-immigration-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/clearzone-immigration/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Europa Immigration** | `private-assets/client-logos/europa-immigration-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/europa-immigration/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Quick Immigration Service** | `private-assets/client-logos/quick-immigration-service-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/quick-immigration-service/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
| **Unique Lahore Lab Sahiwal** | `private-assets/client-logos/unique-lahore-lab-sahiwal-logo.svg` | No | Pending | Pending | No | `logo.svg` | `public/brands/unique-lahore-lab-sahiwal/logo.svg` | [BrandExperience.astro](../../../src/components/sections/BrandExperience.astro) | Requires explicit user confirmation |
