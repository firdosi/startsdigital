...
## Related Asset Intake Documents

- [Production Asset Manifest](./production-asset-manifest.md) — Master replacement manifest mapping source locations to public repository paths.
- [Private Asset Drop Guide](./private-asset-drop-guide.md) — Local intake instructions for dropping raw original assets into `private-assets/`.
