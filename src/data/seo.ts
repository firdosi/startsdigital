...
export const pageSeoRegistry: Record<string, PageSeoConfig> = {
  ...
  '/work/rapidline-immigration-services/': {
    title: 'Rapidline Immigration Services Client Experience | Starts Digital',
    description: 'Creative design, video editing, ad scriptwriting, and campaign creative production for Dubai immigration services.',
    canonicalPath: '/work/rapidline-immigration-services/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Rapidline Immigration Services Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Rapidline Immigration Services',
    projectId: 'rapidline-immigration-services',
  },
  '/work/rapidzone/': {
    title: 'Rapidzone Client Experience Profile | Starts Digital',
    description: 'Advertising video production and creative design for business setup and immigration campaigns in Dubai.',
    canonicalPath: '/work/rapidzone/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Rapidzone Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Rapidzone',
    projectId: 'rapidzone',
  },
  '/work/clearzone-immigration/': {
    title: 'Clearzone Immigration Client Experience | Starts Digital',
    description: 'Custom AI character pipeline, video ad creative production, and paid social campaign support for Dubai immigration services.',
    canonicalPath: '/work/clearzone-immigration/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Clearzone Immigration Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Clearzone Immigration',
    projectId: 'clearzone-immigration',
  },
  '/work/riyadh-finish-pro/': {
    title: 'Riyadh Finish Pro Client Experience | Starts Digital',
    description: 'Website development, Facebook page setup, graphic design, and Google Business Profile / Maps setup for Riyadh contractor services.',
    canonicalPath: '/work/riyadh-finish-pro/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Riyadh Finish Pro Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Riyadh Finish Pro',
    projectId: 'riyadh-finish-pro',
  },
  '/work/viral-naturals/': {
    title: 'Viral Naturals Client Experience Profile | Starts Digital',
    description: 'Complete business setup from scratch, brand presentation, website development, social accounts, creative production, and digital marketing.',
    canonicalPath: '/work/viral-naturals/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Viral Naturals Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Viral Naturals',
    projectId: 'viral-naturals',
  },
  '/work/shopinq-online/': {
    title: 'Shopinq Online Client Experience Profile | Starts Digital',
    description: 'Promoted startup products on a 20% sales commission model, running paid social campaigns, creative production, and customer order support.',
    canonicalPath: '/work/shopinq-online/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Shopinq Online Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Shopinq Online',
    projectId: 'shopinq-online',
  },
  '/work/super-safety-covers/': {
    title: 'Super Safety Covers Client Experience | Starts Digital',
    description: 'Business setup from scratch, Facebook page setup, advertising creative, product positioning, and initial digital-marketing structure.',
    canonicalPath: '/work/super-safety-covers/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Super Safety Covers Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Super Safety Covers',
    projectId: 'super-safety-covers',
  },
  '/work/unique-lahore-lab-sahiwal/': {
    title: 'Unique Lahore Lab Sahiwal Client Experience | Starts Digital',
    description: 'Creative and visual support producing AI-assisted ad creatives and graphics from original diagnostic laboratory photography.',
    canonicalPath: '/work/unique-lahore-lab-sahiwal/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Unique Lahore Lab Sahiwal Client Experience Profile',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'Unique Lahore Lab Sahiwal',
    projectId: 'unique-lahore-lab-sahiwal',
  },
  '/industries/': {
