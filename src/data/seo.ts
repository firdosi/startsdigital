...
export const pageSeoRegistry: Record<string, PageSeoConfig> = {
  ...
  '/tools/': {
    title: 'Technology & Workflow Ecosystem | Starts Digital',
    description: 'Explore the platforms, software tools, frameworks, and AI workflows used by Starts Digital to deliver client projects across advertising, analytics, development, design, and automation.',
    canonicalPath: '/tools/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Technology & Workflow Ecosystem — Starts Digital',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'page',
  ...
  '/work/my-coach-live/': {
    title: 'My Coach Live - Remote Fitness Coaching Case Study | Starts Digital',
    description: 'Explore Starts Digital\'s ongoing project support for My Coach Live, a remote online fitness coaching platform serving UK and US clients with live trainer guidance, nutrition plans, and session booking.',
    canonicalPath: '/work/my-coach-live/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'My Coach Live Case Study — Starts Digital',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
    breadcrumbLabel: 'My Coach Live',
  },
  '/work/convort-ai/': {
    title: 'ConvortAI - Product Development & Growth Case Study | Starts Digital',
    description: 'Explore Starts Digital\'s ongoing product development, web app engineering, creative content, and digital growth partnership with ConvortAI.',
    canonicalPath: '/work/convort-ai/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'ConvortAI Case Study — Starts Digital',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
  ...
  '/work/shopinq-online/': {
    title: 'Shopinq Online - E-Commerce Distribution & Video Showcase | Starts Digital',
    description: 'Explore Starts Digital\'s campaign work, product video creative production, customer communication, and paid social distribution for Shopinq Online.',
    canonicalPath: '/work/shopinq-online/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Shopinq Online Case Study — Starts Digital',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
    schemaType: 'case-study',
