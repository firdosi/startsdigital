...
export const pageSeoRegistry: Record<string, PageSeoConfig> = {
  ...
  '/work/': {
    title: 'Digital Marketing Work & Combined Results | Starts Digital',
    description: 'Explore combined results and digital work delivered across advertising, websites, SEO, creative content, social media and AI-supported marketing workflows.',
    canonicalPath: '/work/',
    ogType: 'website',
    ogImage: '/og/default-og.png',
    ogImageAlt: 'Digital Marketing Work & Combined Results — Starts Digital',
    ogImageWidth: 1200,
    ogImageHeight: 630,
    robots: 'index, follow',
